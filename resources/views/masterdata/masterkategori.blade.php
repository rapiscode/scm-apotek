...
@section('title', 'APOTEK SAYA - Master Kategori')
@section('page_title', 'Daftar Kategori')
@section('page_subtitle', 'Kelola data kategori produk.')
    ...
    <div class="space-y-4">
        <div class="bg-white dark:bg-gray-950 rounded-xl shadow-sm border border-gray-100 dark:border-gray-800 p-4 transition-colors duration-200">
            ...
            <div class="flex items-center justify-between gap-4 flex-wrap mb-4">
                <h2 class="text-3xl font-bold text-blue-700 dark:text-blue-400">Daftar Kategori</h2>
                ...
                <div class="bg-blue-600 px-4 py-4">
                    <div class="grid grid-cols-1 lg:grid-cols-12 gap-3 items-end">
                        ...
                        <div class="lg:col-span-10">
                            <label class="block text-sm font-semibold text-white mb-2">Cari Kategori</label>
                            <div class="relative">
                                <input
                                    type="text"
                    ...
                    <table class="w-full text-sm">
                        <thead class="bg-gray-50 dark:bg-gray-900 text-gray-700 dark:text-gray-300">
                            <tr>
                                ...
                                <th class="text-center px-4 py-3 font-semibold w-36">Actions</th>
                            </tr>
                        </thead>
